...
var indexByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.indexByUser(req.params.id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
...
var indexCompleteByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.indexCompleteByUser(req.params.id)];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [2 /*return*/];
